/**
 * 통합 데이터 파일
 * - 이 템플릿의 텍스트/링크/섹션 구조 데이터를 한곳에 모아 관리합니다.
 * - Tally → Zapier → Notion → Cursor 흐름에서 최종적으로 생성/교체하기 가장 좋은 핵심 파일입니다.
 * - 실무에서는 고객별로 이 파일만 교체하거나 일부 값만 덮어써도 전체 사이트 내용을 바꿀 수 있습니다.
 */
import {
  Award,
  Calendar,
